...
public class Player {
    ...
    private int score = 0;
    private int levelOfRisk = 0;

    public Player(CompetitorType competitorType, String fristName){
        this(competitorType, fristName, 0);
    }

    public Player(CompetitorType competitorType, String fristName, int levelOfRisk){
